...
with open(data_file, "a") as file:
    file.write("# PMS5003 data\n" \
               ...
               "# * number of particles >0.3 μm / 0.1 L of air\n" \
               "# * number of particles >0.5 μm / 0.1 L of air\n" \
               "# * number of particles >1.0 μm / 0.1 L of air\n" \
               "# * number of particles >2.5 μm / 0.1 L of air\n" \
               "# * number of particles >5 μm / 0.1 L of air\n" \
               "# * number of particles >10 μm / 0.1 L of air\n".format(datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S")))
...
while True:
    ...
    pgw_pms5003.labels('number of particles >0.3 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(0.3))
    pgw_pms5003.labels('number of particles >0.5 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(0.5))
    pgw_pms5003.labels('number of particles >1.0 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(1.0))
    pgw_pms5003.labels('number of particles >2.5 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(2.5))
    pgw_pms5003.labels('number of particles >5 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(5))
    pgw_pms5003.labels('number of particles >10 μm / 0.1 L of air').set(sensor_raw_data.pm_per_1l_air(10))
